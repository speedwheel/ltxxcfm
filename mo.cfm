...
<h2>Missouri (MO) Test Scraper</h2>
...
<table style="font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif'" cellspacing="1" cellpadding="4" bgcolor="grey">
	<cfloop query="qryRecord">
		...
		<cftry>
			...
			<cfhttp method="POST" url="https://ltxx.bunity.com/v1/mo" result="resultText">
			...
			<cfelse>
				...
				<tr bgcolor="white">
					...
					<td>Profession: #json.profession#</td>
				</tr>
