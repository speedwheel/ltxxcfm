...
<h2>Minnesota (MN) Test Scraper</h2>
...
<cfif previewSearch neq "">
	<cfquery name="qryRecord">
		...
		WHERE lc.fk_stateID = 24 <!---this is the state ID--->
...
<table style="font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif'" cellspacing="1" cellpadding="4" bgcolor="grey">
	<cfloop query="qryRecord">
		...
		<cftry>
			...
			<cfhttp method="POST" url="https://ltxx.bunity.com/v1/mn" result="resultText">
			...
			<cfelse>
				...
				<tr bgcolor="white">
					...
					<td>
						Effective Date: #dateformat(left(json.effective_date,10),'mm/dd/yyyy')#
						<br>
