...
<h2>New York (NY) Test Scraper</h2>
...
<table style="font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif'" cellspacing="1" cellpadding="4" bgcolor="grey">
	<cfloop query="qryRecord">
		...
		<cftry>
			...
			<cfhttp method="POST" url="https://ltxx.bunity.com/v1/ny" result="resultText">
			...
			<cfelse>
				...
				<tr bgcolor="white">
					<td>#json.name#</td>
					<td><cftry>#json.license_type#<cfcatch>..</cfcatch></cftry></td>
					<td><cftry>#json.license# Exp: #dateformat(left(json.expiration_date,10),'mm/dd/yyyy')#<cfcatch>..</cfcatch></cftry></td>
					<td colspan="2">&nbsp;</td>
				</tr>
