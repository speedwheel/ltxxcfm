...
<cfif previewSearch neq "">
	<cfquery name="qryRecord">
		...
		WHERE lc.fk_stateID = 13 <!---this is the state ID--->
...
<table style="font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif'" cellspacing="1" cellpadding="4" bgcolor="grey">
	<cfloop query="qryRecord">
		...
		<cftry>
			...
			<cfhttp method="POST" url="https://ltxx.bunity.com/v1/id" result="resultText">
						...
						<table>
							...
							<cfloop from="1" to="#ArrayLen(jsonData.courses)#" index="i">
								...
								<tr align="left">
									...
									<td>#item.status#</td>
									<td>#item.hours#</td>
									<td>#dateformat(left(item.completion_date,10),'mm/dd/yyyy')#</td>
								</tr>
							</cfloop>
						</table>
					</td>
