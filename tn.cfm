...
<h2>Tennessee (TN) Test Scraper</h2>
...
<cfif previewSearch neq "">
	<cfquery name="getRecord">
		...
		WHERE lc.fk_stateID = 43 <!---this is the state ID--->
...
<table style="font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif'" cellspacing="1" cellpadding="4" bgcolor="grey">
	<cfloop query="qryRecord">
		...
		<cftry>
			...
			<cfhttp method="POST" url="https://ltxx.bunity.com/v1/tn" result="resultText">
			...
			<cfelse>
				<tr bgcolor="white">
					<td>#jsonData.first_name# #jsonData.middle_name# #jsonData.last_name#</td>
