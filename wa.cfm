...
<h2>Washington (WA) Test Scraper</h2>
...
<cfif previewSearch neq "">
	<cfquery name="getRecord">
		...
		WHERE lc.fk_stateID = 48 <!---this is the state ID--->
...
<table style="font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif'" cellspacing="1" cellpadding="4" bgcolor="grey">
	<cfloop query="qryRecord">
		...
		<cftry>
			...
			<cfhttp method="POST" url="https://ltxx.bunity.com/v1/wa" result="resultText">
				...
				<!--- <cfhttpparam name="license_type" type="formfield" value="#qryRecord.apiType#"> --->
			</cfhttp>
			...
			<cfelse>
				...
				<tr bgcolor="white">
					...
					<td>
						<cftry>First Issued Date: #dateformat(left(json.first_issued_date,10),'mm/dd/yyyy')#<cfcatch>..</cfcatch></cftry>
					</td>
					<td>
						<cftry>Issued Date: #dateformat(left(json.issued_date,10),'mm/dd/yyyy')#<cfcatch>..</cfcatch></cftry>
					</td>
				</tr>
