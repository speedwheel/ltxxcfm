...
<cfif previewSearch neq "">
	<cfquery name="getRecord">
		...
		WHERE lc.fk_stateID = 46 <!---this is the state ID--->
...
<table style="font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif'" cellspacing="1" cellpadding="4" bgcolor="grey">
	<cfloop query="qryRecord">
		...
		<cftry>
			...
			<cfhttp method="POST" url="https://ltxx.bunity.com/v1/vt" result="resultText">
			...
			<cfelse>
				...
				<tr bgcolor="white">
					<td>#json.first_name# #json.middle_name# #json.last_name#</td>
					<td>#json.licnse_type#</td>
