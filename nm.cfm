...
<h2>New Mexico (NM) Test Scraper</h2>
...
<table style="font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif'" cellspacing="1" cellpadding="4" bgcolor="grey">
	<cfloop query="qryRecord">
		...
		<cftry>
            ...
            <cfif qryRecord.l_name eq "NMF">
                <cfhttp method="POST" url="https://ltxx.bunity.com/v1/nm" result="resultText">
                    ...
                    <cfhttpparam name="search_type" type="formfield" value="facility">
                </cfhttp>
            <cfelse>
                <cfhttp method="POST" url="https://ltxx.bunity.com/v1/nm" result="resultText">
                    <cfhttpparam type="header" name="Authorization" value="Basic a2F6ZWxpOj5zWzVaN11bRU4rayk7U2s=">
			...
			<cfelse>
				...
				<tr bgcolor="white">
					...
					<td>Exp: <cfif isDefined('jsonData.expiration_date')>#dateformat(left(jsonData.expiration_date,10),'mm/dd/yyyy')#<cfelse>N/A</cfif></td>
