...
<h2>New Jersey (NJ) Test Scraper</h2>
...
<table style="font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif'" cellspacing="1" cellpadding="4" bgcolor="grey">
	<cfloop query="qryRecord">
		...
		<cftry>
			...
			<cfhttp method="POST" url="https://ltxx.bunity.com/v1/nj" result="resultText">
			...
			<cfelse>
				...
				<tr bgcolor="white">
					<td>#json.name#</td>
					<td><cftry>#json.business_name#<cfcatch>..</cfcatch></cftry></td>
					...
					<td>
						Issued Date: <cftry>#dateformat(left(json.issued_date,10),'mm/dd/yyyy')#<cfcatch>Err</cfcatch></cftry>
					</td>
				</tr>
