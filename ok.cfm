...
<h2>Oklahoma (OK) Test Scraper</h2>
...
<cfif previewSearch neq "">
	<cfquery name="qryRecord">
		...
		WHERE lc.fk_stateID = 37 <!---this is the state ID--->
...
<table style="font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif'" cellspacing="1" cellpadding="4" bgcolor="grey">
	<cfloop query="qryRecord">
		...
		<cftry>
			...
			<cfhttp method="POST" url="https://ltxx.bunity.com/v1/ok" result="resultText">
			...
			<cfelse>
				...
				<tr bgcolor="white">
					<td><cftry>#json.name#<cfcatch>..</cfcatch></cftry></td>
